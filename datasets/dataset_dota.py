...
#                          'helicopter'
#                          ]
        self.category = ['airport', 'plane', 'helicopter', 'bridge', 'small-vehicle', 'harbor', 
                         'ground-track-field', 'storage-tank', 'helipad', 'large-vehicle', 'container-crane', 'roundabout',
                         'swimming-pool', 'baseball-diamond', 'basketball-court', 'ship', 'tennis-court', 'soccer-ball-field']
